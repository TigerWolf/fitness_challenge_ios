...
////            #else
//            return "https://challengecup.club/"
////        #endif
//    }
//    
...
//        {
//            let manager = Alamofire.Manager.sharedInstance
//            var checkURL = ServicesController.url + "v1/status?build_number=\(bundleVersion)&version=\(bundleShortVersion)"
//            
//            if self.isLoggedIn() {
//                checkURL += "&username=\(self.user!.username)"
//                
//                let mixpanel = Mixpanel.sharedInstance()
//                mixpanel.identify(self.user!.username)
//                mixpanel.people.set(["email":self.user!.username])
//            }
//            
